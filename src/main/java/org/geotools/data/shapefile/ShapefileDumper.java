...
public class ShapefileDumper {
  ...
  //  }
                ...
                if (multiWriter && f.getDefaultGeometry() == null) {
                    ...
                    nullStoreWriter =
                            nullStoreWriter == null
                                    ? getStoreWriter(
                                            fileName, schema, null, multiWriter, Point.class, "_NULL")
                                    : nullStoreWriter;
    ...
    private StoreWriter getStoreWriter(
            String fileName, SimpleFeature f, Map<Class<?>, StoreWriter> writers, boolean multiWriter)
            throws IOException {
        ...
        return getStoreWriter(fileName, f.getFeatureType(), writers, multiWriter, target, geometryType);
    }
